import { AcademicProjectSupervisionMeetingScheduledDto } from '@core-service/integrations/notification/dto/emails/academic-project-supervision-meeting-scheduled.dto';
import { AccountEmailChangeDto } from '@core-service/integrations/notification/dto/emails/account-email-change.dto';
import {
  ActivateAccountDto,
...
} from '@core-service/integrations/notification/dto/emails/activate-or-deactivate-account.dto';
import { CoSuperVisorDto } from '@core-service/integrations/notification/dto/emails/co-supervisor.dto';
import { NewLoginDto } from '@core-service/integrations/notification/dto/emails/new-login.dto';
import { PanelAssignmentDto } from '@core-service/integrations/notification/dto/emails/panel-assignment.dto';
import { PasswordResetDto } from '@core-service/integrations/notification/dto/emails/password-reset.dto';
import { PortfolioApprovalDto } from '@core-service/integrations/notification/dto/emails/porfolio-approval.dto';
import { PortfoliRevisionRequiredDto } from '@core-service/integrations/notification/dto/emails/portfolio-revision-required.dto';
import { ProjectCollaborationReplyDto } from '@core-service/integrations/notification/dto/emails/project-collaboration-reply.dto';
import { ProjectCollaborationRequestDto } from '@core-service/integrations/notification/dto/emails/project-collaboration-request.dto';
import { ProjectPublicationDto } from '@core-service/integrations/notification/dto/emails/project-publication.dto';
import { ProjectStatusChangeDto } from '@core-service/integrations/notification/dto/emails/project-status-change.dto';
import { StudentConceptPaperSupervisorDto } from '@core-service/integrations/notification/dto/emails/student-concept-paper-supervisor-action.dto';
import { StudentDefensePresentationScheduledDto } from '@core-service/integrations/notification/dto/emails/student-defense-presentation-scheduled.dto';
import { StudentEditorDocumentCommentDto } from '@core-service/integrations/notification/dto/emails/student-editor-document.dto';
import { StudentHodTopicResponseDto } from '@core-service/integrations/notification/dto/emails/student-hod-topic-response';
import { StudentPanelReviewScheduledDto } from '@core-service/integrations/notification/dto/emails/student-panel-review-scheduled.dto';
import { StudentProjectPublicationOrRejectionto } from '@core-service/integrations/notification/dto/emails/student-project-publication-or-rejetion.dto';
import { StudentProposalPresentationFeedbackDto } from '@core-service/integrations/notification/dto/emails/student-proposal-presentation-feedback.dto';
import { StudentRecommendationDto } from '@core-service/integrations/notification/dto/emails/student-recommendation.dto';
import { StudentSupervisionMeetingCompletedDto } from '@core-service/integrations/notification/dto/emails/student-supervision-meeting-completed.dto';
import { StudentSupervisorAssignmentDto } from '@core-service/integrations/notification/dto/emails/student-supervisor-assignment.dto';
import { StudentTopicSubmissionDto } from '@core-service/integrations/notification/dto/emails/student-topic-submission.dto';
import { SupervisorAssignemtDto } from '@core-service/integrations/notification/dto/emails/supervisor-assignment.dto';
import { SupervisorConceptPaperSubmissionDto } from '@core-service/integrations/notification/dto/emails/supervisor-concept-paper-submission.dto';
import { SupervisorHodPanelAssignment } from '@core-service/integrations/notification/dto/emails/supervisor-hod-panel-assignment.dto';
import { SupervisorNewProjectDto } from '@core-service/integrations/notification/dto/emails/supervisor-new-project';
import { SupervisorPostDefenseRevisionSubmited } from '@core-service/integrations/notification/dto/emails/supervisor-post-defense-revision-submited.dto';
import { SupervisorProjectVerdictDto } from '@core-service/integrations/notification/dto/emails/supervisor-project-verditct.dto';
import { UserOnboardVerificationDto } from '@core-service/integrations/notification/dto/emails/user-onboard-verification.dto';
...
import { TwoFactorAuthStatusChangeDto } from '@core-service/integrations/notification/dto/emails/two-factor-auth-status-change.dto';
import { EmailNotificationsStatusChangeDto } from '@core-service/integrations/notification/dto/emails/email-notifications-status-change.dto';
import { HodTopicSubmissionDto } from '@core-service/integrations/notification/dto/emails/hod-topic-submission.dto';
import { BaseEmailDto } from '@core-service/integrations/notification/dto/emails/base-email.dto';
import { ResendOtpDto } from '@core-service/integrations/notification/dto/emails/resend-otp.dto';
import { CustomerRegistrationDto } from '@core-service/integrations/notification/dto/emails/customer-registration.dto';
import { DepositSuccessDto } from '@core-service/integrations/notification/dto/emails/deposit-success.dto';
import { WithdrawalSuccessDto } from '@core-service/integrations/notification/dto/emails/withdrawal-success.dto';
import { LoanApprovedDto } from '@core-service/integrations/notification/dto/emails/loan-approved.dto';
import { LoanDisbursedDto } from '@core-service/integrations/notification/dto/emails/loan-disbursed.dto';
import { RepaymentReceivedDto } from '@core-service/integrations/notification/dto/emails/repayment-received.dto';
import { RepaymentDueDto } from '@core-service/integrations/notification/dto/emails/repayment-due.dto';
import { PaymentOverdueDto } from '@core-service/integrations/notification/dto/emails/payment-overdue.dto';
import { LoanDefaultedDto } from '@core-service/integrations/notification/dto/emails/loan-defaulted.dto';
import { TierUpgradeDto } from '@core-service/integrations/notification/dto/emails/tier-upgrade.dto';
import { LateFeeAppliedDto } from '@core-service/integrations/notification/dto/emails/late-fee-applied.dto';
import { InterestCreditedDto } from '@core-service/integrations/notification/dto/emails/interest-credited.dto';
